...
def mqtt_publish(arg_broker_url, arg_broker_port, arg_mqtt_topic, arg_mqtt_message, arg_mqtt_qos):
    try:        
        ...
        return -1
#---------------------------------------------------
"""def http_publish(arg_mess0,arg_message1,arg_message2):
    try:
        parameters = {'id':'Sheet1','x':'goal.message[0]','y':'arg_message1','theta':'arg_message2'} 

        URL = "https://script.google.com/macros/s/AKfycbxPnhWDjVV7NrrlJ3e9arigxubN9_qVllhFEVy-ECYbEllaBEx2/exec"
